...
async function writeExerciseSpec(exercisePath) {
    ...
    const trueExerciseName = isSolutionFile ? `${exerciseName}-solution` : exerciseName;
...
`;
    ...
    await writeFile(join(exercisePath, `${trueExerciseName}.spec.js`), exerciseSpecContent);
}
